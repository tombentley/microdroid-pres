...
var $$req$ = require; require = (typeof $$ceylon$require == 'undefined') ? $$req$ : function() { return $$ceylon$require('ceylon/interop/browser/1.3.0/ceylon.interop.browser-1.3.0', $$req$, Array.prototype.slice.call(arguments)); }

var _CTM$;function $CCMM$(){if (_CTM$===undefined)_CTM$=require('ceylon/interop/browser/1.3.0/ceylon.interop.browser-1.3.0-model').$CCMM$;return _CTM$;}
ex$.$CCMM$=$CCMM$;
var m$1=require('ceylon/language/1.3.0/ceylon.language-1.3.0');
m$1.$addmod$(m$1,'ceylon.language/1.3.0');
m$1.$addmod$(ex$,'ceylon.interop.browser/1.3.0');
...
window$.open$defs$url=function($3uz,$3v0,$3v1,$3v2){return "about:blank";};
window$.open$defs$target=function($3uz,$3v0,$3v1,$3v2){return "_blank";};
window$.open$defs$features=function($3uz,$3v0,$3v1,$3v2){return "";};
window$.open$defs$replace=function($3uz,$3v0,$3v1,$3v2){return false;};
window$.alert$defs$message=function($3v3){return "";};
window$.confirm$defs$message=function($3v4){return "";};
window$.prompt$defs$message=function($3v5,$3v6){return "";};
window$.prompt$defs$default=function($3v5,$3v6){return "";};
}
...
$init$Window();
function WindowProxy(){var $3v7={t:$init$Window()};$3v7.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser','WindowProxy']};};return $3v7;}
...
history$.pushState$defs$url=function($3v8,$3v9,$3va){return null;};
history$.replaceState$defs$url=function($3vb,$3vc,$3vd){return null;};
}
...
function newEventInternal$internal($3ve,$3vf){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'14:14-14:17','nativeObjects.ceylon'):eval)("Event");return m$1.dre$$(($3vg=$3ve,$3vh=$3vf,$3vi=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'15:15-15:17','nativeObjects.ceylon'):obj),$3vi.$$===undefined?new $3vi($3vg, $3vh):$3vi($3vg, $3vh)),{t:$init$Event()},'nativeObjects.ceylon 15:15-15:40');
}
...
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'22:14-22:17','nativeObjects.ceylon'):eval)("XMLHttpRequest");return m$1.dre$$(($3vj=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'23:15-23:17','nativeObjects.ceylon'):obj),$3vj.$$===undefined?new $3vj():$3vj()),{t:$init$XMLHttpRequest()},'nativeObjects.ceylon 23:15-23:21');
}
...
function newTextInternal$internal($3vk){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'29:14-29:17','nativeObjects.ceylon'):eval)("Text");return m$1.dre$$(($3vl=$3vk,$3vm=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'30:15-30:17','nativeObjects.ceylon'):obj),$3vm.$$===undefined?new $3vm($3vl):$3vm($3vl)),{t:$init$Text()},'nativeObjects.ceylon 30:15-30:25');
}
...
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'36:14-36:17','nativeObjects.ceylon'):eval)("Range");return m$1.dre$$(($3vn=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'37:15-37:17','nativeObjects.ceylon'):obj),$3vn.$$===undefined?new $3vn():$3vn()),{t:$init$Range()},'nativeObjects.ceylon 37:15-37:21');
}
...
function newCommentInternal$internal($3vo){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'43:14-43:17','nativeObjects.ceylon'):eval)("Comment");return m$1.dre$$(($3vp=$3vo,$3vq=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'44:15-44:17','nativeObjects.ceylon'):obj),$3vq.$$===undefined?new $3vq($3vp):$3vq($3vp)),{t:$init$Comment()},'nativeObjects.ceylon 44:15-44:25');
}
...
xMLHttpRequest$.open$defs$async=function($3vr,$3vs,$3vt,$3vu,$3vv){return false;};
xMLHttpRequest$.open$defs$username=function($3vr,$3vs,$3vt,$3vu,$3vv){return null;};
xMLHttpRequest$.open$defs$password=function($3vr,$3vs,$3vt,$3vu,$3vv){return null;};
xMLHttpRequest$.send$defs$data=function($3vw){return null;};
}
...
eventTarget$.addEventListener$defs$capture=function($3vx,$3vy,$3vz){return false;};
eventTarget$.removeEventListener$defs$capture=function($3w0,$3w1,$3w2){return false;};
}
...
$init$EventListener();
function EventHandler$dom(){var $3w3={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([{t:$init$Event()}]),Return$Callable:{t:m$1.Anything}}};$3w3.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','EventHandler']};};return $3w3;}
...
$init$Event();
function newEvent$dom$defs$eventInitDict($3w4,$3w5){return null;};
function newEvent$dom($3w4,$3w5){if($3w5===undefined){$3w5=null;}
return newEventInternal$internal($3w4,$3w5);
};
...
$init$EventInit$dom();
function DOMTimeStamp$dom(){var $3w6={t:m$1.Integer};$3w6.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','DOMTimeStamp']};};return $3w6;}
...
function OnErrorEventHandler$dom(){var $3w7={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([m$1.mut$([{t:m$1.$_String},{t:$init$Event()}]),m$1.mut$([{t:m$1.Null},{t:m$1.$_String}]),m$1.mut$([{t:m$1.Null},{t:m$1.Integer}]),m$1.mut$([{t:m$1.Null},{t:m$1.Integer}]),{t:m$1.Anything}]),Return$Callable:{t:m$1.Anything}}};$3w7.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','OnErrorEventHandler']};};return $3w7;}
ex$.OnErrorEventHandler$dom=OnErrorEventHandler$dom;
function OnBeforeUnloadEventHandler$dom(){var $3w8={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([{t:$init$Event()}]),Return$Callable:m$1.mut$([{t:m$1.Null},{t:m$1.$_String}])}};$3w8.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','OnBeforeUnloadEventHandler']};};return $3w8;}
...
function Node(node$){
EventTarget(node$);
node$.cloneNode$defs$deep=function($3w9){return false;};
}
...
document$.importNode$defs$deep=function($3wa,$3wb){return false;};
document$.createNodeIterator$defs$whatToShow=function($3wc,$3wd,$3we){return 4294967295;};
document$.createNodeIterator$defs$filter=function($3wc,$3wd,$3we){return null;};
document$.createTreeWalker$defs$whatToShow=function($3wf,$3wg,$3wh){return 4294967295;};
document$.createTreeWalker$defs$filter=function($3wf,$3wg,$3wh){return null;};
document$.open$defs$typeOrUrl=function($3wi,$3wj,$3wk,$3wl){return "text/html";};
document$.open$defs$replaceOrName=function($3wi,$3wj,$3wk,$3wl){return "";};
document$.open$defs$features=function($3wi,$3wj,$3wk,$3wl){return "";};
document$.open$defs$replace=function($3wi,$3wj,$3wk,$3wl){return false;};
document$.execCommand$defs$showUI=function($3wm,$3wn,$3wo){return false;};
document$.execCommand$defs$val=function($3wm,$3wn,$3wo){return "";};
}
...
function openDocument$dom($3wp,$3wq){
if($3wp===undefined){$3wp="text/html";}
if($3wq===undefined){$3wq="";}
var $3wr;
m$1.asrt$((m$1.is$(($3wr=document$dom().open($3wp,$3wq)),{t:$init$Document()})),"Assertion failed: \'is Document doc = document.open(type, replace)\' at nodes.ceylon (196:11-196:58)",'196:4-196:59','nodes.ceylon');
return $3wr;
}
...
function openWindow$dom($3ws,$3wt,$3wu,$3wv){
if($3wv===undefined){$3wv=false;}
var $3ww;
m$1.asrt$((m$1.is$(($3ww=document$dom().open($3ws,$3wt,$3wu,$3wv)),WindowProxy())),"Assertion failed: \'is WindowProxy doc = document.open(url, name, features, replace)\' at nodes.ceylon (204:11-204:76)",'204:4-204:77','nodes.ceylon');
return $3ww;
}
...
dOMImplementation$.createDocument$defs$doctype=function($3wx,$3wy,$3wz){return null;};
}
...
$init$Text();
function newText$dom$defs$text($3x0){return "";};
function newText$dom($3x0){if($3x0===undefined){$3x0="";}
return newTextInternal$internal($3x0);
};
...
$init$Comment();
function newComment$dom$defs$data($3x1){return "";};
function newComment$dom($3x1){if($3x1===undefined){$3x1="";}
return newCommentInternal$internal($3x1);
};
...
range$.collapse$defs$toStart=function($3x2){return false;};
}
