...
window$.open$defs$url=function($3uv,$3uw,$3ux,$3uy){return "about:blank";};
window$.open$defs$target=function($3uv,$3uw,$3ux,$3uy){return "_blank";};
window$.open$defs$features=function($3uv,$3uw,$3ux,$3uy){return "";};
window$.open$defs$replace=function($3uv,$3uw,$3ux,$3uy){return false;};
window$.alert$defs$message=function($3uz){return "";};
window$.confirm$defs$message=function($3v0){return "";};
window$.prompt$defs$message=function($3v1,$3v2){return "";};
window$.prompt$defs$default=function($3v1,$3v2){return "";};
}
...
$init$Window();
function WindowProxy(){var $3v3={t:$init$Window()};$3v3.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser','WindowProxy']};};return $3v3;}
...
history$.pushState$defs$url=function($3v4,$3v5,$3v6){return null;};
history$.replaceState$defs$url=function($3v7,$3v8,$3v9){return null;};
}
...
function newEventInternal$internal($3va,$3vb){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'14:14-14:17','nativeObjects.ceylon'):eval)("Event");return m$1.dre$$(($3vc=$3va,$3vd=$3vb,$3ve=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'15:15-15:17','nativeObjects.ceylon'):obj),$3ve.$$===undefined?new $3ve($3vc, $3vd):$3ve($3vc, $3vd)),{t:$init$Event()},'nativeObjects.ceylon 15:15-15:40');
}
...
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'22:14-22:17','nativeObjects.ceylon'):eval)("XMLHttpRequest");return m$1.dre$$(($3vf=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'23:15-23:17','nativeObjects.ceylon'):obj),$3vf.$$===undefined?new $3vf():$3vf()),{t:$init$XMLHttpRequest()},'nativeObjects.ceylon 23:15-23:21');
}
...
function newTextInternal$internal($3vg){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'29:14-29:17','nativeObjects.ceylon'):eval)("Text");return m$1.dre$$(($3vh=$3vg,$3vi=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'30:15-30:17','nativeObjects.ceylon'):obj),$3vi.$$===undefined?new $3vi($3vh):$3vi($3vh)),{t:$init$Text()},'nativeObjects.ceylon 30:15-30:25');
}
...
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'36:14-36:17','nativeObjects.ceylon'):eval)("Range");return m$1.dre$$(($3vj=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'37:15-37:17','nativeObjects.ceylon'):obj),$3vj.$$===undefined?new $3vj():$3vj()),{t:$init$Range()},'nativeObjects.ceylon 37:15-37:21');
}
...
function newCommentInternal$internal($3vk){
obj=(typeof eval==='undefined'||eval===null?m$1.throwexc(m$1.Exception("Undefined or null reference: eval"),'43:14-43:17','nativeObjects.ceylon'):eval)("Comment");return m$1.dre$$(($3vl=$3vk,$3vm=(typeof obj==='undefined'?m$1.throwexc(m$1.Exception("Undefined type obj"),'44:15-44:17','nativeObjects.ceylon'):obj),$3vm.$$===undefined?new $3vm($3vl):$3vm($3vl)),{t:$init$Comment()},'nativeObjects.ceylon 44:15-44:25');
}
...
xMLHttpRequest$.open$defs$async=function($3vn,$3vo,$3vp,$3vq,$3vr){return false;};
xMLHttpRequest$.open$defs$username=function($3vn,$3vo,$3vp,$3vq,$3vr){return null;};
xMLHttpRequest$.open$defs$password=function($3vn,$3vo,$3vp,$3vq,$3vr){return null;};
xMLHttpRequest$.send$defs$data=function($3vs){return null;};
}
...
eventTarget$.addEventListener$defs$capture=function($3vt,$3vu,$3vv){return false;};
eventTarget$.removeEventListener$defs$capture=function($3vw,$3vx,$3vy){return false;};
}
...
$init$EventListener();
function EventHandler$dom(){var $3vz={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([{t:$init$Event()}]),Return$Callable:{t:m$1.Anything}}};$3vz.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','EventHandler']};};return $3vz;}
...
$init$Event();
function newEvent$dom$defs$eventInitDict($3w0,$3w1){return null;};
function newEvent$dom($3w0,$3w1){if($3w1===undefined){$3w1=null;}
return newEventInternal$internal($3w0,$3w1);
};
...
$init$EventInit$dom();
function DOMTimeStamp$dom(){var $3w2={t:m$1.Integer};$3w2.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','DOMTimeStamp']};};return $3w2;}
...
function OnErrorEventHandler$dom(){var $3w3={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([m$1.mut$([{t:m$1.$_String},{t:$init$Event()}]),m$1.mut$([{t:m$1.Null},{t:m$1.$_String}]),m$1.mut$([{t:m$1.Null},{t:m$1.Integer}]),m$1.mut$([{t:m$1.Null},{t:m$1.Integer}]),{t:m$1.Anything}]),Return$Callable:{t:m$1.Anything}}};$3w3.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','OnErrorEventHandler']};};return $3w3;}
ex$.OnErrorEventHandler$dom=OnErrorEventHandler$dom;
function OnBeforeUnloadEventHandler$dom(){var $3w4={t:m$1.Callable,a:{Arguments$Callable:m$1.mtt$([{t:$init$Event()}]),Return$Callable:m$1.mut$([{t:m$1.Null},{t:m$1.$_String}])}};$3w4.$crtmm$=function(){return{mod:$CCMM$,pa:1,d:['ceylon.interop.browser.dom','OnBeforeUnloadEventHandler']};};return $3w4;}
...
function Node(node$){
EventTarget(node$);
node$.cloneNode$defs$deep=function($3w5){return false;};
}
...
document$.importNode$defs$deep=function($3w6,$3w7){return false;};
document$.createNodeIterator$defs$whatToShow=function($3w8,$3w9,$3wa){return 4294967295;};
document$.createNodeIterator$defs$filter=function($3w8,$3w9,$3wa){return null;};
document$.createTreeWalker$defs$whatToShow=function($3wb,$3wc,$3wd){return 4294967295;};
document$.createTreeWalker$defs$filter=function($3wb,$3wc,$3wd){return null;};
document$.open$defs$typeOrUrl=function($3we,$3wf,$3wg,$3wh){return "text/html";};
document$.open$defs$replaceOrName=function($3we,$3wf,$3wg,$3wh){return "";};
document$.open$defs$features=function($3we,$3wf,$3wg,$3wh){return "";};
document$.open$defs$replace=function($3we,$3wf,$3wg,$3wh){return false;};
document$.execCommand$defs$showUI=function($3wi,$3wj,$3wk){return false;};
document$.execCommand$defs$val=function($3wi,$3wj,$3wk){return "";};
}
...
function openDocument$dom($3wl,$3wm){
if($3wl===undefined){$3wl="text/html";}
if($3wm===undefined){$3wm="";}
var $3wn;
m$1.asrt$((m$1.is$(($3wn=document$dom().open($3wl,$3wm)),{t:$init$Document()})),"Assertion failed: \'is Document doc = document.open(type, replace)\' at nodes.ceylon (196:11-196:58)",'196:4-196:59','nodes.ceylon');
return $3wn;
}
...
function openWindow$dom($3wo,$3wp,$3wq,$3wr){
if($3wr===undefined){$3wr=false;}
var $3ws;
m$1.asrt$((m$1.is$(($3ws=document$dom().open($3wo,$3wp,$3wq,$3wr)),WindowProxy())),"Assertion failed: \'is WindowProxy doc = document.open(url, name, features, replace)\' at nodes.ceylon (204:11-204:76)",'204:4-204:77','nodes.ceylon');
return $3ws;
}
...
dOMImplementation$.createDocument$defs$doctype=function($3wt,$3wu,$3wv){return null;};
}
...
$init$Text();
function newText$dom$defs$text($3ww){return "";};
function newText$dom($3ww){if($3ww===undefined){$3ww="";}
return newTextInternal$internal($3ww);
};
...
$init$Comment();
function newComment$dom$defs$data($3wx){return "";};
function newComment$dom($3wx){if($3wx===undefined){$3wx="";}
return newCommentInternal$internal($3wx);
};
...
range$.collapse$defs$toStart=function($3wy){return false;};
}
